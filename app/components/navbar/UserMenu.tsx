  ...
  return (
    <div className="relative" >
      <div className="flex fle-row items-center gap-3">
        ...
        <div onClick={toggleOpen} className="p-4 md:py-1 md:px-2 border-[1px] border-neutral-100 flex flex-row items-center gap-3 rounded-full cursor-pointer hover:shadow-md trasnition ">
          <AiOutlineMenu />
